<template>
  <address class="not-italic flex gap-x-2">
    <inline-svg :src="svgPath" class="h-4 w-4 fill-slate-400 mt-1" ></inline-svg>
    <div>
      ...
      {{ location.postcode }} {{ location.city }}, {{ location.country }}</p>
    </div>
  </address>
</template>
...
export default {
  ...
  computed: {
    svgPath() : String {
      return require('~/static/icons/location.svg')
    }
  }
}
</script>
